...
Version  : 1.18.0
Release  : 4
URL      : http://lv2plug.in/spec/lv2-1.18.0.tar.bz2
Source0  : http://lv2plug.in/spec/lv2-1.18.0.tar.bz2
Source1  : http://lv2plug.in/spec/lv2-1.18.0.tar.bz2.sig
...
%prep
%setup -q -n lv2-1.18.0
cd %{_builddir}/lv2-1.18.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640893244
...
cp %{_builddir}/lv2-1.18.0/COPYING %{buildroot}/usr/share/package-licenses/lv2/aa46356a85da2de55033d4e6ec85e1daf477ba50
cp %{_builddir}/lv2-1.18.0/waflib/COPYING %{buildroot}/usr/share/package-licenses/lv2/e9888c41b011115aedfb5fec830b2b5409fa69e2
%make_install
